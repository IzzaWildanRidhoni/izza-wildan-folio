  ...
  const experiences = [
    {
      ...
      location: "Remote",
      description: "Membangun aplikasi web modern mencakup UI, API, dan integrasi sistem backend.",
      type: "current"
    },
    {
      ...
      location: "Indonesia",
      description: "Perancangan dan implementasi solusi web, dukungan infrastruktur, serta optimasi aplikasi internal.",
      type: "current"
    },
    {
      ...
      location: "Yogyakarta",
      description: "Mengelola konten digital, koordinasi media sosial, dan produksi media visual untuk mendukung kegiatan dakwah.",
      type: "current"
    },
    {
      ...
      location: "Yogyakarta",
      description: "Membantu dalam pengajaran dan praktikum database management systems.",
      type: "past"
    },
    {
      ...
      location: "Indonesia",
      description: "Pengembangan aplikasi web full-stack dengan fokus pada efisiensi dan user experience.",
      type: "past"
    },
    {
      ...
      location: "Remote",
      description: "Mengembangkan komponen front-end dan back-end dalam program bootcamp intensif.",
      type: "past"
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Perjalanan karir sebagai Full Stack Developer di berbagai perusahaan dan proyek
            </p>
          </div>
                ...
                >
                  ...
                  <Card className="ml-0 md:ml-20 p-6 bg-gray-800/30 border-gray-700 glass-effect hover:bg-gray-800/50 transition-all duration-300">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
                      <div>
                        <h3 className="text-xl font-bold text-white mb-2 font-poppins">{exp.title}</h3>
