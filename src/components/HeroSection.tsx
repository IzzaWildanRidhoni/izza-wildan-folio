      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in">
            <p className="text-cyan-400 text-lg mb-4 font-medium">👋 Halo, saya</p>
          </div>
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <p className="text-xl md:text-2xl text-gray-300 mb-2">Full Stack Web Developer</p>
            <p className="text-lg text-gray-400 mb-8">S.Kom. • Certified Programmer (BNSP)</p>
          </div>
          
          {/* Description */}
          <div className="animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <p className="text-gray-300 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              Lulusan Informatika dengan pengalaman mengembangkan aplikasi web modern. 
              Berfokus pada solusi full-stack yang efisien dan user-friendly.
            </p>
          </div>
          
          {/* CTA Buttons */}
          <div className="animate-fade-in flex flex-col sm:flex-row gap-4 justify-center mb-12" style={{ animationDelay: '0.8s' }}>
            <Button 
              size="lg" 
          ...
          {/* Social Links */}
          <div className="animate-fade-in flex justify-center gap-6" style={{ animationDelay: '1s' }}>
            <a 
